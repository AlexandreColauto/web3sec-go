// eventlog.go: the append-only event log — Log, the ONLY writer, with its
// genesis/chain-head/mirror-lag pipeline, plus the JSONL blank-line
// framing predicate every reader shares.
package state
